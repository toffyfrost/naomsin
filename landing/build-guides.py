...
<div class="wrap">
  ...
  <section id="sms"><h2>📩 SMS เงินเข้า → จดเองอัตโนมัติ</h2><p class="lead">ตั้งครั้งเดียว ทุกครั้งที่มี SMS เงินเข้า น้องออมสินบันทึกยอดขายและทักบอกยอดรวมวันนี้</p>
    <div class="card">
      ...
      <div class="step"><div class="n">3</div><div><b>Android:</b> แอป MacroDroid → ทริกเกอร์ "SMS ที่ได้รับ" (หรือ "การแจ้งเตือน" ของแอปธนาคาร) → HTTP Request แบบ POST ไปที่ลิงก์</div></div>
